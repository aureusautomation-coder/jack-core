...
Skills provide your tools. When you need one, check its `SKILL.md`. Keep local notes (SSH details, device nicknames) in `TOOLS.md`.
...
When you receive a heartbeat poll, check `HEARTBEAT.md` if it exists. Use heartbeats for background work:
